...
public class RequestsReceivedActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView = (ListView) findViewById(R.id.list_received_requests);
...
//                startActivity(i);
    ...
    private class fetchRequests extends AsyncTask<Void, Void, JSONObject> {
        ...
        protected void onPreExecute() {
            ...
            mProgress = new ProgressDialog(RequestsReceivedActivity.this);
                ...
                if(responseJson.has("status") ) {
                    try {
                        ...
                        if (result.equals("success") && responseJson.getJSONArray("tradeRequests").length() > 0){
                            ...
                            adapter = new RequestsReceivedViewAdapter(RequestsReceivedActivity.this, R.layout.requestreceiveditem_listview, requestArrayList);
